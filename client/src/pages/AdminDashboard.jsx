    ...
    <div className="min-h-screen bg-gray-100 p-10">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5">
        ...
        >
          ...
          <p className="text-6xl mt-5 text-blue-500 font-bold">
        ...
        >
          ...
          <p className="text-6xl mt-5 text-green-500 font-bold">
            {analytics.totalJobs}
          </p>
        ...
        >
          ...
          <p className="text-6xl mt-5 text-red-500 font-bold">
