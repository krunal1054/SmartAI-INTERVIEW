        ...
        <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-300 mb-8">
              SmartHire AI is a modern MERN Stack
              Job Portal platform where users can
              search jobs, apply with resume,
              and companies can hire top talent.
            </p>
            ...
            <div className="flex gap-5">
              ...
              <Link
                to="/jobs"
                className="bg-white text-black px-6 py-3 rounded-lg font-bold hover:bg-gray-200"
              >
                Explore Jobs
              </Link>
              ...
              <Link
                to="/register"
                className="border border-white px-6 py-3 rounded-lg font-bold hover:bg-white hover:text-black"
              >
                Get Started
              </Link>
      ...
      <div className="py-20 px-10">
        ...
        <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto">
          ...
          <div className="bg-white p-10 rounded-xl shadow-lg hover:shadow-2xl transition">
            ...
            <p className="text-gray-600">
              Upload resumes easily and apply
...
>
  ...
  <div className="relative z-10 max-w-7xl mx-auto px-10 grid md:grid-cols-2 gap-10 items-center">
...
<FaBriefcase className="text-5xl text-blue-600 mb-5" />
            <h2 className="text-3xl font-bold mb-5">
              Job Search
            </h2>
          ...
          <div className="bg-white p-10 rounded-xl shadow-lg hover:shadow-2xl transition">
<FaFileUpload className="text-5xl text-green-600 mb-5" />
            <h2 className="text-3xl font-bold mb-5">
              Resume Upload
            </h2>
          ...
          <div className="bg-white p-10 rounded-xl shadow-lg hover:shadow-2xl transition">
<FaChartBar className="text-5xl text-red-600 mb-5" />
            <h2 className="text-3xl font-bold mb-5">
              Admin Dashboard
            </h2>
...
<div className="py-20 bg-white">
  ...
  <div className="grid md:grid-cols-3 gap-10 max-w-7xl mx-auto px-10">
    ...
    <div className="bg-gray-50 p-10 rounded-xl shadow">
      ...
      <FaRobot className="text-5xl mb-5" />
    ...
    <div className="bg-gray-50 p-10 rounded-xl shadow">
      ...
      <FaBrain className="text-5xl mb-5" />
