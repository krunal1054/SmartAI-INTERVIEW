...
function Contact() {
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      >
        <div className="bg-black/70 p-10 rounded-2xl text-center">
      ...
      <div className="max-w-7xl mx-auto p-10">
        ...
        <div className="space-y-5">
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <p className="mt-2 text-gray-600">
              AI automatically evaluates candidate answers
              using Gemini AI.
            </p>
          </div>
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <p className="mt-2 text-gray-600">
              Simply visit the Resume Upload page and
          ...
          <div className="bg-white p-6 rounded-xl shadow">
            ...
            <p className="mt-2 text-gray-600">
              Rankings are based on interview performance
              and AI evaluation.
            </p>
          </div>
